            ...
            <div className="max-w-4xl mx-auto">
                ...
                {!activeFile ? (
                    <div className="flex flex-col items-center justify-center min-h-[50vh] bg-white rounded-[2rem] border border-slate-100 shadow-sm p-8 text-center animate-in fade-in slide-in-from-bottom-4 duration-700">
                        <div className="w-20 h-20 bg-violet-50 text-violet-600 rounded-3xl flex items-center justify-center mb-6 shadow-violet-200 shadow-xl -rotate-2">
                            <Mic2 size={32} />
                        </div>
                        <h1 className="text-3xl font-black text-slate-900 mb-2">Vocal Remover</h1>
                        <p className="text-slate-500 max-w-xs mx-auto mb-8">Isolate vocals from any song using our advanced Center-Channel Extraction AI.</p>

                        <label className="cursor-pointer bg-violet-600 text-white px-8 py-4 rounded-xl font-bold text-sm uppercase tracking-widest hover:bg-violet-700 transition-all active:scale-95 shadow-lg shadow-violet-500/20">
                            Upload Song
